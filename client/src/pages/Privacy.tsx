        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Идентификатор пользователя в социальных сетях (Apple ID, ВКонтакте)</li>
            </ul>

            <h3 className="text-lg font-medium mt-4 mb-2">3.2. Данные, получаемые при авторизации через ВКонтакте:</h3>
            <p className="mb-2">
              При входе через ВКонтакте (VK ID) мы получаем доступ к следующим данным вашего профиля:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Имя и фамилия</strong> — для персонализации вашего аккаунта</li>
              <li><strong>Адрес электронной почты</strong> — для связи и восстановления доступа (при наличии)</li>
              <li><strong>Идентификатор пользователя VK</strong> — для однозначной идентификации аккаунта</li>
            </ul>
            <p className="mt-2 text-sm text-muted-foreground">
              Эти данные используются исключительно для создания и идентификации вашей учётной записи
              в Сервисе. Мы не публикуем информацию от вашего имени и не получаем доступ к вашим
              сообщениям, друзьям или другим приватным данным ВКонтакте.
            </p>

            <h3 className="text-lg font-medium mt-4 mb-2">3.3. Данные, собираемые автоматически:</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>IP-адрес</li>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2">3.4. Данные в мобильном приложении:</h3>
            <ul className="list-disc pl-6 space-y-2">
