...
// Account portal — redirect to main page with params
app.get('/account', (req, res) => {
    const section = req.query.section || 'paresis';
    const uid = req.query.uid || '';
    const lang = req.query.lang || 'ru';
    res.redirect(`/?nosology=${encodeURIComponent(section)}&user_id=${encodeURIComponent(uid)}&lang=${encodeURIComponent(lang)}`);
});
...
📋 Endpoints:
    ...
    GET  /account?section=xxx&uid=xxx   - Redirect from app
